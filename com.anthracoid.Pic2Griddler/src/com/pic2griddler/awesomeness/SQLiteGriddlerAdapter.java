...
public class SQLiteGriddlerAdapter extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String query = "CREATE TABLE " + griddlerTable + " (" + id + " INT(32)," + author + " TEXT," + name + " TEXT," + rank + " INT(32)," + solution + " TEXT," + current + " TEXT," + difficulty + " VARCHAR(16)," + width + " INT(12)," + height
