...
public class RadialSelectorView extends View {
	...
	public int getDegreesFromCoords(final float pointX, final float pointY, final boolean forceLegal,
		...
		if (this.mHasInnerCircle) {
			if (forceLegal) {
				...
				final int distanceToInnerNumber = (int) Math.abs(hypotenuse - innerNumberRadius);
				final int outerNumberRadius = (int) (this.mCircleRadius * this.mOuterNumbersRadiusMultiplier);
				final int distanceToOuterNumber = (int) Math.abs(hypotenuse - outerNumberRadius);
			...
			if (!forceLegal) {
				final int distanceToNumber = (int) Math.abs(hypotenuse - this.mLineLength);
	...
	public ObjectAnimator getDisappearAnimator() {
		...
		final ObjectAnimator disappearAnimator = ObjectAnimator.ofPropertyValuesHolder(
	...
	public ObjectAnimator getReappearAnimator() {
		...
		final ObjectAnimator reappearAnimator = ObjectAnimator.ofPropertyValuesHolder(
	 ...
	 */
	public void initialize(final Context context, final boolean is24HourMode, final boolean hasInnerCircle,
			final boolean disappearsOut, final int selectionDegrees, final boolean isInnerCircle) {
		...
		final int blue = res.getColor(R.color.blue);
	 ...
	 */
	public void setSelection(final int selectionDegrees, final boolean isInnerCircle, final boolean forceDrawDot) {
